    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav>
            <ul class="sidebar-nav">
                <li class="nav-item">
                    <a href="${pageContext.request.contextPath}/adherant/accueil" class="nav-link active">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="${pageContext.request.contextPath}/reservation/form" class="dropdown-item">Reserver un livre</a></li>
